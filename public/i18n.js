...
(function() {
  ...
  var PHASE9_BLOG_SLUGS = {
    'base64-vs-url-encoding': 'base64Url',
    'csv-to-json-vs-json-to-csv': 'csvJson',
    'duplicate-finder-vs-file-organizer': 'duplicateOrganizer',
    'image-compressor-vs-image-resizer': 'imageResize',
    'json-formatter-vs-json-validator': 'jsonValidation',
    'markdown-to-html-vs-html-to-markdown': 'markdownHtml',
    'mortgage-calculator-vs-refinance-calculator': 'mortgageRefinance',
    'pdf-merge-vs-pdf-split': 'pdfMergeSplit',
    'unit-converter-vs-scientific-calculator': 'unitScientific',
    'word-counter-vs-character-counter': 'wordCharacter'
  };

  var PHASE10_BLOG_SLUGS = {
    'five-minute-pdf-cleanup-workflow': 'pdfCleanup',
    'blog-publishing-tool-workflow': 'blogPublishing',
    'content-review-before-client-delivery': 'contentReview',
    'data-cleanup-before-dashboard-import': 'dataDashboard',
    'developer-debugging-tool-chain': 'developerDebugging',
    'monthly-finance-document-routine': 'monthlyFinance',
    'remote-team-meeting-and-file-workflow': 'remoteMeeting',
    'small-business-file-prep-stack': 'smallBusinessFiles',
    'support-ticket-evidence-prep': 'supportEvidence',
    'tool-selection-map-for-new-users': 'toolSelection'
  };

  var PHASE9_TOPIC_TITLES = {
    en: {
      base64Url: 'Base64 vs URL Encoding: Similar Looking Tools, Different Purposes',
      csvJson: 'CSV to JSON vs JSON to CSV: Choose the Right Direction',
      duplicateOrganizer: 'Duplicate Finder vs File Organizer for Digital Cleanup',
      imageResize: 'Image Compressor vs Image Resizer: Which Fixes Your Problem?',
      jsonValidation: 'JSON Formatter vs JSON Validator: Different Jobs, Better Debugging',
      markdownHtml: 'Markdown to HTML vs HTML to Markdown for Publishing Workflows',
      mortgageRefinance: 'Mortgage Calculator vs Refinance Calculator: Which Estimate Do You Need?',
      pdfMergeSplit: 'PDF Merge vs PDF Split: Which Tool Should You Open First?',
      unitScientific: 'Unit Converter vs Scientific Calculator for Technical Work',
      wordCharacter: 'Word Counter vs Character Counter for Editing Decisions'
    },
    tr: { base64Url: 'Base64 ve URL Kodlama: Benzer Görünen Araçlar, Farklı Amaçlar', csvJson: 'CSV’den JSON’a ve JSON’dan CSV’ye: Doğru Yönü Seçme', duplicateOrganizer: 'Dijital Temizlikte Duplicate Finder ve File Organizer Karşılaştırması', imageResize: 'Image Compressor ve Image Resizer: Sorununuzu Hangisi Çözer?', jsonValidation: 'JSON Formatter ve JSON Validator: Farklı İşler, Daha İyi Hata Ayıklama', markdownHtml: 'Yayın Akışlarında Markdown’dan HTML’ye ve HTML’den Markdown’a', mortgageRefinance: 'Mortgage Calculator ve Refinance Calculator: Hangi Tahmine İhtiyacınız Var?', pdfMergeSplit: 'PDF Merge ve PDF Split: Önce Hangi Aracı Açmalısınız?', unitScientific: 'Teknik İşlerde Unit Converter ve Scientific Calculator Karşılaştırması', wordCharacter: 'Düzenleme Kararları İçin Word Counter ve Character Counter' },
    de: { base64Url: 'Base64 vs. URL-Encoding: ähnliche Tools, unterschiedliche Zwecke', csvJson: 'CSV zu JSON vs. JSON zu CSV: die richtige Richtung wählen', duplicateOrganizer: 'Duplicate Finder vs. File Organizer für digitale Aufräumarbeiten', imageResize: 'Image Compressor vs. Image Resizer: welches Tool löst Ihr Problem?', jsonValidation: 'JSON Formatter vs. JSON Validator: unterschiedliche Aufgaben, besseres Debugging', markdownHtml: 'Markdown zu HTML vs. HTML zu Markdown für Publishing-Workflows', mortgageRefinance: 'Hypothekenrechner vs. Refinanzierungsrechner: welche Schätzung brauchen Sie?', pdfMergeSplit: 'PDF Merge vs. PDF Split: welches Tool zuerst öffnen?', unitScientific: 'Unit Converter vs. Scientific Calculator für technische Arbeit', wordCharacter: 'Word Counter vs. Character Counter für Bearbeitungsentscheidungen' },
    fr: { base64Url: 'Base64 vs encodage URL : outils semblables, usages différents', csvJson: 'CSV vers JSON ou JSON vers CSV : choisir le bon sens', duplicateOrganizer: 'Duplicate Finder vs File Organizer pour le nettoyage numérique', imageResize: 'Image Compressor vs Image Resizer : lequel règle votre problème ?', jsonValidation: 'JSON Formatter vs JSON Validator : tâches différentes, meilleur débogage', markdownHtml: 'Markdown vers HTML ou HTML vers Markdown pour les workflows de publication', mortgageRefinance: 'Calculateur hypothécaire vs calculateur de refinancement : quelle estimation choisir ?', pdfMergeSplit: 'Fusion PDF vs division PDF : quel outil ouvrir d’abord ?', unitScientific: 'Unit Converter vs Scientific Calculator pour le travail technique', wordCharacter: 'Word Counter vs Character Counter pour les décisions d’édition' },
    es: { base64Url: 'Base64 frente a codificación URL: herramientas parecidas, usos distintos', csvJson: 'CSV a JSON frente a JSON a CSV: elegir la dirección correcta', duplicateOrganizer: 'Duplicate Finder frente a File Organizer para limpieza digital', imageResize: 'Image Compressor frente a Image Resizer: ¿cuál arregla el problema?', jsonValidation: 'JSON Formatter frente a JSON Validator: tareas distintas, mejor depuración', markdownHtml: 'Markdown a HTML frente a HTML a Markdown en flujos de publicación', mortgageRefinance: 'Calculadora hipotecaria frente a refinanciación: qué estimación necesita', pdfMergeSplit: 'Unir PDF frente a dividir PDF: qué herramienta abrir primero', unitScientific: 'Unit Converter frente a Scientific Calculator para trabajo técnico', wordCharacter: 'Word Counter frente a Character Counter para decisiones de edición' },
    pt: { base64Url: 'Base64 vs codificação URL: ferramentas parecidas, objetivos diferentes', csvJson: 'CSV para JSON vs JSON para CSV: escolha a direção certa', duplicateOrganizer: 'Duplicate Finder vs File Organizer para limpeza digital', imageResize: 'Image Compressor vs Image Resizer: qual resolve seu problema?', jsonValidation: 'JSON Formatter vs JSON Validator: trabalhos diferentes, melhor depuração', markdownHtml: 'Markdown para HTML vs HTML para Markdown em fluxos de publicação', mortgageRefinance: 'Calculadora de hipoteca vs refinanciamento: qual estimativa você precisa?', pdfMergeSplit: 'Mesclar PDF vs dividir PDF: qual ferramenta abrir primeiro?', unitScientific: 'Unit Converter vs Scientific Calculator para trabalho técnico', wordCharacter: 'Word Counter vs Character Counter para decisões de edição' },
    ru: { base64Url: 'Base64 и URL-кодирование: похожие инструменты, разные задачи', csvJson: 'CSV в JSON или JSON в CSV: выберите правильное направление', duplicateOrganizer: 'Duplicate Finder или File Organizer для цифровой уборки', imageResize: 'Image Compressor или Image Resizer: что решит вашу проблему?', jsonValidation: 'JSON Formatter или JSON Validator: разные задачи и лучшее отладочное чтение', markdownHtml: 'Markdown в HTML или HTML в Markdown для публикации', mortgageRefinance: 'Ипотечный калькулятор или калькулятор рефинансирования: какая оценка нужна?', pdfMergeSplit: 'Объединение PDF или разделение PDF: что открыть первым?', unitScientific: 'Unit Converter или Scientific Calculator для технической работы', wordCharacter: 'Word Counter или Character Counter для решений по редактированию' },
    zh: { base64Url: 'Base64 与 URL 编码：外观相似，目的不同', csvJson: 'CSV 转 JSON 与 JSON 转 CSV：选择正确方向', duplicateOrganizer: 'Duplicate Finder 与 File Organizer：数字清理怎么选', imageResize: 'Image Compressor 与 Image Resizer：哪个能解决问题？', jsonValidation: 'JSON Formatter 与 JSON Validator：不同任务，更好调试', markdownHtml: 'Markdown 转 HTML 与 HTML 转 Markdown：发布流程选择', mortgageRefinance: '房贷计算器与再融资计算器：你需要哪种估算？', pdfMergeSplit: 'PDF 合并与 PDF 拆分：应该先打开哪个工具？', unitScientific: '技术工作中的 Unit Converter 与 Scientific Calculator', wordCharacter: '编辑决策中的 Word Counter 与 Character Counter' },
    ja: { base64Url: 'Base64とURLエンコード：似て見えるツール、異なる目的', csvJson: 'CSVからJSONかJSONからCSVか：正しい方向を選ぶ', duplicateOrganizer: 'デジタル整理のためのDuplicate FinderとFile Organizer比較', imageResize: 'Image CompressorとImage Resizer：問題を解決するのはどちらか', jsonValidation: 'JSON FormatterとJSON Validator：異なる役割でより良いデバッグ', markdownHtml: '公開ワークフローでのMarkdownからHTMLとHTMLからMarkdown', mortgageRefinance: '住宅ローン計算機と借り換え計算機：必要な見積もりはどちらか', pdfMergeSplit: 'PDF結合とPDF分割：最初に開くべきツール', unitScientific: '技術作業のためのUnit ConverterとScientific Calculator', wordCharacter: '編集判断のためのWord CounterとCharacter Counter' },
    ko: { base64Url: 'Base64와 URL 인코딩: 비슷해 보이지만 목적이 다른 도구', csvJson: 'CSV to JSON vs JSON to CSV: 올바른 방향 선택하기', duplicateOrganizer: '디지털 정리를 위한 Duplicate Finder와 File Organizer 비교', imageResize: 'Image Compressor와 Image Resizer: 어느 도구가 문제를 해결할까?', jsonValidation: 'JSON Formatter와 JSON Validator: 다른 역할, 더 나은 디버깅', markdownHtml: '게시 워크플로의 Markdown to HTML과 HTML to Markdown', mortgageRefinance: '모기지 계산기와 재융자 계산기: 어떤 추정이 필요할까?', pdfMergeSplit: 'PDF Merge와 PDF Split: 먼저 열어야 할 도구', unitScientific: '기술 작업을 위한 Unit Converter와 Scientific Calculator', wordCharacter: '편집 결정을 위한 Word Counter와 Character Counter' },
    ar: { base64Url: 'Base64 مقابل ترميز URL: أدوات متشابهة وأغراض مختلفة', csvJson: 'CSV إلى JSON أم JSON إلى CSV: اختر الاتجاه الصحيح', duplicateOrganizer: 'Duplicate Finder مقابل File Organizer للتنظيف الرقمي', imageResize: 'Image Compressor أم Image Resizer: أيهما يحل المشكلة؟', jsonValidation: 'JSON Formatter مقابل JSON Validator: مهام مختلفة وتصحيح أفضل', markdownHtml: 'Markdown إلى HTML أم HTML إلى Markdown لسير النشر', mortgageRefinance: 'حاسبة الرهن أم حاسبة إعادة التمويل: أي تقدير تحتاج؟', pdfMergeSplit: 'دمج PDF أم تقسيم PDF: أي أداة تفتح أولًا؟', unitScientific: 'Unit Converter مقابل Scientific Calculator للعمل التقني', wordCharacter: 'Word Counter مقابل Character Counter لقرارات التحرير' },
    hi: { base64Url: 'Base64 vs URL encoding: समान दिखने वाले tools, अलग purposes', csvJson: 'CSV to JSON vs JSON to CSV: सही direction चुनें', duplicateOrganizer: 'Digital cleanup के लिए Duplicate Finder vs File Organizer', imageResize: 'Image Compressor vs Image Resizer: आपकी problem कौन ठीक करता है?', jsonValidation: 'JSON Formatter vs JSON Validator: अलग काम, बेहतर debugging', markdownHtml: 'Publishing workflows में Markdown to HTML vs HTML to Markdown', mortgageRefinance: 'Mortgage Calculator vs Refinance Calculator: कौन सा estimate चाहिए?', pdfMergeSplit: 'PDF Merge vs PDF Split: पहले कौन सा tool खोलें?', unitScientific: 'Technical work के लिए Unit Converter vs Scientific Calculator', wordCharacter: 'Editing decisions के लिए Word Counter vs Character Counter' },
    it: { base64Url: 'Base64 vs codifica URL: strumenti simili, scopi diversi', csvJson: 'CSV in JSON vs JSON in CSV: scegliere la direzione giusta', duplicateOrganizer: 'Duplicate Finder vs File Organizer per la pulizia digitale', imageResize: 'Image Compressor vs Image Resizer: quale risolve il problema?', jsonValidation: 'JSON Formatter vs JSON Validator: compiti diversi, debug migliore', markdownHtml: 'Markdown in HTML vs HTML in Markdown nei workflow di pubblicazione', mortgageRefinance: 'Calcolatore mutuo vs rifinanziamento: quale stima serve?', pdfMergeSplit: 'Unire PDF vs dividere PDF: quale strumento aprire prima?', unitScientific: 'Unit Converter vs Scientific Calculator per lavoro tecnico', wordCharacter: 'Word Counter vs Character Counter per decisioni di editing' },
    pl: { base64Url: 'Base64 kontra kodowanie URL: podobne narzędzia, różne cele', csvJson: 'CSV do JSON kontra JSON do CSV: wybierz właściwy kierunek', duplicateOrganizer: 'Duplicate Finder kontra File Organizer do cyfrowego porządku', imageResize: 'Image Compressor kontra Image Resizer: co rozwiąże problem?', jsonValidation: 'JSON Formatter kontra JSON Validator: różne zadania, lepsze debugowanie', markdownHtml: 'Markdown do HTML kontra HTML do Markdown w procesach publikacji', mortgageRefinance: 'Kalkulator hipoteczny kontra refinansowania: jakiego szacunku potrzebujesz?', pdfMergeSplit: 'Łączenie PDF kontra dzielenie PDF: które narzędzie otworzyć najpierw?', unitScientific: 'Unit Converter kontra Scientific Calculator w pracy technicznej', wordCharacter: 'Word Counter kontra Character Counter przy decyzjach edycyjnych' },
    nl: { base64Url: 'Base64 versus URL-encoding: vergelijkbare tools, andere doelen', csvJson: 'CSV naar JSON versus JSON naar CSV: kies de juiste richting', duplicateOrganizer: 'Duplicate Finder versus File Organizer voor digitale opruiming', imageResize: 'Image Compressor versus Image Resizer: welke lost je probleem op?', jsonValidation: 'JSON Formatter versus JSON Validator: andere taken, beter debuggen', markdownHtml: 'Markdown naar HTML versus HTML naar Markdown voor publicatieworkflows', mortgageRefinance: 'Hypotheekcalculator versus herfinancieringscalculator: welke schatting heb je nodig?', pdfMergeSplit: 'PDF samenvoegen versus PDF splitsen: welke tool open je eerst?', unitScientific: 'Unit Converter versus Scientific Calculator voor technisch werk', wordCharacter: 'Word Counter versus Character Counter voor bewerkingskeuzes' }
  };

  var PHASE10_TOPIC_TITLES = {
    en: {
      pdfCleanup: 'A Five-Minute PDF Cleanup Workflow Before Sending Documents',
      blogPublishing: 'Blog Publishing Tool Workflow From Draft to Clean Assets',
      contentReview: 'Content Review Before Client Delivery: Text, PDF, and Image Checks',
      dataDashboard: 'Data Cleanup Before Dashboard Import: A Lightweight Workflow',
      developerDebugging: 'Developer Debugging Tool Chain for Small Front-End Issues',
      monthlyFinance: 'Monthly Finance Document Routine With Browser Utilities',
      remoteMeeting: 'Remote Team Meeting and File Workflow',
      smallBusinessFiles: 'Small Business File Prep Stack for Invoices, Images, and Reports',
      supportEvidence: 'Support Ticket Evidence Prep With Screenshots, PDFs, and Text',
      toolSelection: 'Tool Selection Map for New Users: Start With the Task'
    },
    tr: { pdfCleanup: 'Belge Göndermeden Önce Beş Dakikalık PDF Temizleme Akışı', blogPublishing: 'Taslaklardan Temiz Dosyalara Blog Yayınlama Araç Akışı', contentReview: 'Müşteri Tesliminden Önce İçerik Kontrolü: Metin, PDF ve Görsel', dataDashboard: 'Pano İçe Aktarımından Önce Veri Temizliği: Hafif Bir Akış', developerDebugging: 'Küçük Front-End Sorunları İçin Geliştirici Hata Ayıklama Araç Zinciri', monthlyFinance: 'Tarayıcı Yardımcılarıyla Aylık Finans Belgesi Rutini', remoteMeeting: 'Uzaktan Ekip Toplantısı ve Dosya İş Akışı', smallBusinessFiles: 'Fatura, Görsel ve Raporlar İçin Küçük İşletme Dosya Hazırlama Seti', supportEvidence: 'Ekran Görüntüsü, PDF ve Metinle Destek Talebi Kanıt Hazırlığı', toolSelection: 'Yeni Kullanıcılar İçin Araç Seçim Haritası: Görevle Başlayın' },
    de: { pdfCleanup: 'Fünf-Minuten-PDF-Aufräumworkflow vor dem Versenden von Dokumenten', blogPublishing: 'Blog-Publishing-Tool-Workflow vom Entwurf zu sauberen Assets', contentReview: 'Content-Prüfung vor Kundenübergabe: Text-, PDF- und Bildchecks', dataDashboard: 'Datenbereinigung vor Dashboard-Import: ein schlanker Workflow', developerDebugging: 'Developer-Debugging-Toolchain für kleine Front-End-Probleme', monthlyFinance: 'Monatliche Finanzdokumentenroutine mit Browser-Utilities', remoteMeeting: 'Remote-Team-Meeting- und Datei-Workflow', smallBusinessFiles: 'Dateivorbereitungs-Stack für kleine Unternehmen: Rechnungen, Bilder und Berichte', supportEvidence: 'Support-Ticket-Nachweise mit Screenshots, PDFs und Text vorbereiten', toolSelection: 'Tool-Auswahlkarte für neue Nutzer: mit der Aufgabe beginnen' },
    fr: { pdfCleanup: 'Workflow de nettoyage PDF en cinq minutes avant l’envoi', blogPublishing: 'Workflow d’outils de publication de blog, du brouillon aux fichiers propres', contentReview: 'Revue de contenu avant livraison client : textes, PDF et images', dataDashboard: 'Nettoyage des données avant import dans un tableau de bord : workflow léger', developerDebugging: 'Chaîne d’outils de débogage pour petits problèmes front-end', monthlyFinance: 'Routine mensuelle de documents financiers avec outils navigateur', remoteMeeting: 'Workflow de réunion d’équipe à distance et de fichiers', smallBusinessFiles: 'Pile de préparation de fichiers pour factures, images et rapports', supportEvidence: 'Préparer les preuves de ticket support avec captures, PDF et texte', toolSelection: 'Carte de choix d’outils pour nouveaux utilisateurs : partir de la tâche' },
    es: { pdfCleanup: 'Flujo de limpieza PDF de cinco minutos antes de enviar documentos', blogPublishing: 'Flujo de herramientas para publicar blogs desde borrador hasta activos limpios', contentReview: 'Revisión de contenido antes de entregar al cliente: texto, PDF e imágenes', dataDashboard: 'Limpieza de datos antes de importar al panel: flujo ligero', developerDebugging: 'Cadena de herramientas de depuración para pequeños problemas front-end', monthlyFinance: 'Rutina mensual de documentos financieros con utilidades del navegador', remoteMeeting: 'Flujo de reunión remota de equipo y archivos', smallBusinessFiles: 'Pila de preparación de archivos para facturas, imágenes e informes', supportEvidence: 'Preparar evidencias de soporte con capturas, PDF y texto', toolSelection: 'Mapa de selección de herramientas para nuevos usuarios: empiece por la tarea' },
    pt: { pdfCleanup: 'Fluxo de limpeza de PDF em cinco minutos antes de enviar documentos', blogPublishing: 'Fluxo de ferramentas para publicar blog do rascunho aos ativos limpos', contentReview: 'Revisão de conteúdo antes da entrega ao cliente: texto, PDF e imagens', dataDashboard: 'Limpeza de dados antes de importar para dashboard: fluxo leve', developerDebugging: 'Cadeia de ferramentas de depuração para pequenos problemas front-end', monthlyFinance: 'Rotina mensal de documentos financeiros com utilitários do navegador', remoteMeeting: 'Fluxo de reunião remota de equipe e arquivos', smallBusinessFiles: 'Pilha de preparo de arquivos para notas, imagens e relatórios', supportEvidence: 'Preparar evidências de suporte com capturas, PDFs e texto', toolSelection: 'Mapa de seleção de ferramentas para novos usuários: comece pela tarefa' },
    ru: { pdfCleanup: 'Пятиминутная очистка PDF перед отправкой документов', blogPublishing: 'Workflow публикации блога: от черновика к чистым файлам', contentReview: 'Проверка контента перед передачей клиенту: текст, PDF и изображения', dataDashboard: 'Очистка данных перед импортом в дашборд: легкий workflow', developerDebugging: 'Цепочка инструментов разработчика для небольших front-end проблем', monthlyFinance: 'Ежемесячная рутина финансовых документов с браузерными утилитами', remoteMeeting: 'Workflow удаленной командной встречи и файлов', smallBusinessFiles: 'Набор подготовки файлов для малого бизнеса: счета, изображения и отчеты', supportEvidence: 'Подготовка доказательств для тикета: скриншоты, PDF и текст', toolSelection: 'Карта выбора инструментов для новых пользователей: начните с задачи' },
    zh: { pdfCleanup: '发送文件前的五分钟 PDF 清理流程', blogPublishing: '博客发布工具流程：从草稿到干净素材', contentReview: '交付客户前的内容检查：文本、PDF 与图片', dataDashboard: '仪表盘导入前的数据清理：轻量流程', developerDebugging: '小型前端问题的开发者调试工具链', monthlyFinance: '使用浏览器工具的每月财务文档流程', remoteMeeting: '远程团队会议与文件流程', smallBusinessFiles: '小企业发票、图片和报告的文件准备组合', supportEvidence: '用截图、PDF 和文本准备支持工单证据', toolSelection: '新用户工具选择地图：从任务开始' },
    ja: { pdfCleanup: '文書を送る前の5分間PDF整理ワークフロー', blogPublishing: '下書きからきれいな素材までのブログ公開ツールワークフロー', contentReview: 'クライアント納品前のコンテンツ確認：テキスト、PDF、画像', dataDashboard: 'ダッシュボード取り込み前のデータ整理：軽量ワークフロー', developerDebugging: '小さなフロントエンド問題のための開発者デバッグツールチェーン', monthlyFinance: 'ブラウザーユーティリティで行う毎月の財務書類ルーティン', remoteMeeting: 'リモートチーム会議とファイルのワークフロー', smallBusinessFiles: '請求書、画像、レポートのための小規模事業ファイル準備スタック', supportEvidence: 'スクリーンショット、PDF、テキストでサポートチケット証拠を準備する', toolSelection: '新規ユーザー向けツール選択マップ：タスクから始める' },
    ko: { pdfCleanup: '문서를 보내기 전 5분 PDF 정리 워크플로', blogPublishing: '초안에서 깔끔한 자산까지 블로그 게시 도구 워크플로', contentReview: '고객 전달 전 콘텐츠 검토: 텍스트, PDF, 이미지 확인', dataDashboard: '대시보드 가져오기 전 데이터 정리: 가벼운 워크플로', developerDebugging: '작은 프런트엔드 문제를 위한 개발자 디버깅 도구 체인', monthlyFinance: '브라우저 유틸리티로 하는 월간 재무 문서 루틴', remoteMeeting: '원격 팀 회의와 파일 워크플로', smallBusinessFiles: '청구서, 이미지, 보고서를 위한 소규모 비즈니스 파일 준비 스택', supportEvidence: '스크린샷, PDF, 텍스트로 지원 티켓 증거 준비하기', toolSelection: '신규 사용자를 위한 도구 선택 지도: 작업부터 시작하기' },
    ar: { pdfCleanup: 'سير تنظيف PDF في خمس دقائق قبل إرسال المستندات', blogPublishing: 'سير أدوات نشر المدونة من المسودة إلى ملفات نظيفة', contentReview: 'مراجعة المحتوى قبل تسليم العميل: نص وPDF وصور', dataDashboard: 'تنظيف البيانات قبل استيراد لوحة المعلومات: سير خفيف', developerDebugging: 'سلسلة أدوات تصحيح للمطورين لمشكلات Front-End صغيرة', monthlyFinance: 'روتين شهري لمستندات المال باستخدام أدوات المتصفح', remoteMeeting: 'سير اجتماع الفريق عن بُعد والملفات', smallBusinessFiles: 'حزمة إعداد ملفات الأعمال الصغيرة للفواتير والصور والتقارير', supportEvidence: 'تحضير أدلة تذكرة الدعم بلقطات شاشة وPDF ونص', toolSelection: 'خريطة اختيار الأدوات للمستخدمين الجدد: ابدأ بالمهمة' },
    hi: { pdfCleanup: 'Documents भेजने से पहले पाँच मिनट का PDF cleanup workflow', blogPublishing: 'Draft से clean assets तक blog publishing tool workflow', contentReview: 'Client delivery से पहले content review: text, PDF और image checks', dataDashboard: 'Dashboard import से पहले data cleanup: lightweight workflow', developerDebugging: 'Small front-end issues के लिए developer debugging tool chain', monthlyFinance: 'Browser utilities के साथ monthly finance document routine', remoteMeeting: 'Remote team meeting और file workflow', smallBusinessFiles: 'Invoices, images और reports के लिए small business file prep stack', supportEvidence: 'Screenshots, PDFs और text के साथ support ticket evidence prep', toolSelection: 'New users के लिए tool selection map: task से शुरू करें' },
    it: { pdfCleanup: 'Workflow di pulizia PDF in cinque minuti prima di inviare documenti', blogPublishing: 'Workflow strumenti per pubblicare blog dalla bozza agli asset puliti', contentReview: 'Revisione contenuti prima della consegna cliente: testo, PDF e immagini', dataDashboard: 'Pulizia dati prima dell’import in dashboard: workflow leggero', developerDebugging: 'Catena di strumenti di debug per piccoli problemi front-end', monthlyFinance: 'Routine mensile di documenti finanziari con utility browser', remoteMeeting: 'Workflow per riunioni remote di team e file', smallBusinessFiles: 'Stack di preparazione file per fatture, immagini e report', supportEvidence: 'Preparare prove per ticket supporto con screenshot, PDF e testo', toolSelection: 'Mappa di scelta strumenti per nuovi utenti: parti dall’attività' },
    pl: { pdfCleanup: 'Pięciominutowy proces czyszczenia PDF przed wysłaniem dokumentów', blogPublishing: 'Proces publikacji bloga od szkicu do czystych materiałów', contentReview: 'Przegląd treści przed dostawą do klienta: tekst, PDF i obrazy', dataDashboard: 'Czyszczenie danych przed importem do dashboardu: lekki proces', developerDebugging: 'Łańcuch narzędzi debugowania dla małych problemów front-end', monthlyFinance: 'Miesięczna rutyna dokumentów finansowych z narzędziami przeglądarkowymi', remoteMeeting: 'Proces spotkania zdalnego zespołu i plików', smallBusinessFiles: 'Zestaw przygotowania plików dla małej firmy: faktury, obrazy i raporty', supportEvidence: 'Przygotowanie dowodów do zgłoszenia: zrzuty, PDF i tekst', toolSelection: 'Mapa wyboru narzędzi dla nowych użytkowników: zacznij od zadania' },
    nl: { pdfCleanup: 'Vijf minuten PDF-opruimworkflow voordat je documenten verstuurt', blogPublishing: 'Blogpublicatie-toolworkflow van concept tot schone assets', contentReview: 'Contentreview vóór klantlevering: tekst, PDF en afbeeldingen', dataDashboard: 'Data opschonen vóór dashboardimport: lichte workflow', developerDebugging: 'Developer debugging-toolchain voor kleine front-endproblemen', monthlyFinance: 'Maandelijkse financiële documentenroutine met browsertools', remoteMeeting: 'Remote teammeeting- en bestandsworkflow', smallBusinessFiles: 'Bestandsvoorbereidingsstack voor kleine bedrijven: facturen, afbeeldingen en rapporten', supportEvidence: 'Bewijs voor supporttickets voorbereiden met screenshots, PDF’s en tekst', toolSelection: 'Toolselectiekaart voor nieuwe gebruikers: begin met de taak' }
  };

  var PHASE9_COMPARISON_COPY = {
    tr: { category: 'Karşılaştırma rehberleri', cover: 'Karşılaştırma iş akışı', read: '10 dk okuma', lede: '{topic} rehberi iki benzer seçeneği görev, giriş, çıktı ve risk açısından ayırmanıza yardımcı olur.', summaryText: '{topic} için önce hedefi yazın, iki aracın girdilerini ve çıktılarını karşılaştırın, örnekle kontrol edin ve tek bir sonraki adım seçin.', openTool: 'Karşılaştırılan aracı aç', viewTools: 'İlgili kategorileri görüntüle', body: '{topic} için karar verirken amaca, beklenen formata, kaynağın hassasiyetine, geri alınabilirliğe ve sonucu kimin kullanacağına bakın.', detail: 'Sonucu gerçek kullanım yerinde kontrol edin: yayın taslağı, rapor, müşteri paketi, teknik not veya finans tahmini.', relatedParagraph: 'Sonraki adım seçtiğiniz araca bağlıdır. Gerekirse iki kategori merkezini açın ve küçük bir örnekle deneyin.', conclusion: '{topic} en iyi net bir karşılaştırma akışıyla çözülür: görevi tanımlayın, araç rollerini ayırın, sonucu doğrulayın ve gereksiz dönüşümlerden kaçının.' },
    de: { category: 'Vergleichsleitfäden', cover: 'Vergleichsworkflow', read: '10 Min. Lesezeit', lede: 'Dieser Leitfaden zu {topic} trennt zwei ähnliche Optionen nach Aufgabe, Eingabe, Ausgabe und Risiko.', summaryText: 'Für {topic}: Ziel notieren, Eingaben und Ausgaben vergleichen, mit einem Beispiel prüfen und den nächsten Schritt wählen.', openTool: 'Verglichenes Tool öffnen', viewTools: 'Verwandte Kategorien ansehen', body: 'Bei {topic} achten Sie auf Zweck, erwartetes Format, Sensibilität der Quelle, Umkehrbarkeit und darauf, wer das Ergebnis nutzt.', detail: 'Prüfen Sie das Ergebnis im echten Kontext: Veröffentlichungsentwurf, Bericht, Kundenpaket, technische Notiz oder Finanzschätzung.', relatedParagraph: 'Der nächste Schritt hängt vom gewählten Tool ab. Öffnen Sie bei Bedarf beide Kategorien und testen Sie mit einem kleinen Beispiel.', conclusion: '{topic} funktioniert am besten mit einem klaren Vergleichsworkflow: Aufgabe definieren, Tool-Rollen trennen, Ergebnis validieren und unnötige Umwege vermeiden.' },
    fr: { category: 'Guides de comparaison', cover: 'Workflow de comparaison', read: '10 min de lecture', lede: 'Ce guide sur {topic} distingue deux options proches par tâche, entrée, sortie et risque.', summaryText: 'Pour {topic}, notez l’objectif, comparez entrées et sorties, vérifiez avec un exemple et choisissez l’étape suivante.', openTool: 'Ouvrir l’outil comparé', viewTools: 'Voir les catégories liées', body: 'Pour {topic}, regardez l’objectif, le format attendu, la sensibilité de la source, la réversibilité et l’utilisateur du résultat.', detail: 'Contrôlez le résultat dans son contexte réel : brouillon de publication, rapport, dossier client, note technique ou estimation financière.', relatedParagraph: 'L’étape suivante dépend de l’outil choisi. Ouvrez les catégories si nécessaire et testez un petit exemple.', conclusion: '{topic} se gère mieux avec un workflow de comparaison clair : définir la tâche, séparer les rôles des outils, valider le résultat et éviter les conversions inutiles.' },
    es: { category: 'Guías de comparación', cover: 'Flujo de comparación', read: '10 min de lectura', lede: 'Esta guía de {topic} separa dos opciones similares por tarea, entrada, salida y riesgo.', summaryText: 'Para {topic}, escriba el objetivo, compare entradas y salidas, pruebe con un ejemplo y elija el siguiente paso.', openTool: 'Abrir herramienta comparada', viewTools: 'Ver categorías relacionadas', body: 'En {topic}, revise el propósito, el formato esperado, la sensibilidad de la fuente, la reversibilidad y quién usará el resultado.', detail: 'Compruebe el resultado en su contexto real: borrador de publicación, informe, paquete de cliente, nota técnica o estimación financiera.', relatedParagraph: 'El siguiente paso depende de la herramienta elegida. Abra ambas categorías si hace falta y pruebe con un ejemplo pequeño.', conclusion: '{topic} funciona mejor con un flujo de comparación claro: definir la tarea, separar roles de herramientas, validar el resultado y evitar conversiones innecesarias.' },
    pt: { category: 'Guias de comparação', cover: 'Fluxo de comparação', read: '10 min de leitura', lede: 'Este guia sobre {topic} separa duas opções parecidas por tarefa, entrada, saída e risco.', summaryText: 'Para {topic}, escreva o objetivo, compare entradas e saídas, teste com um exemplo e escolha o próximo passo.', openTool: 'Abrir ferramenta comparada', viewTools: 'Ver categorias relacionadas', body: 'Em {topic}, revise objetivo, formato esperado, sensibilidade da fonte, reversibilidade e quem usará o resultado.', detail: 'Confira o resultado no contexto real: rascunho de publicação, relatório, pacote do cliente, nota técnica ou estimativa financeira.', relatedParagraph: 'O próximo passo depende da ferramenta escolhida. Abra as categorias se necessário e teste com um exemplo pequeno.', conclusion: '{topic} funciona melhor com um fluxo claro de comparação: defina a tarefa, separe papéis das ferramentas, valide o resultado e evite conversões desnecessárias.' },
    ru: { category: 'Сравнительные руководства', cover: 'Сравнительный workflow', read: '10 мин чтения', lede: 'Руководство по {topic} помогает различить два похожих варианта по задаче, входным данным, результату и риску.', summaryText: 'Для {topic}: запишите цель, сравните входы и выходы, проверьте на примере и выберите следующий шаг.', openTool: 'Открыть сравниваемый инструмент', viewTools: 'Смотреть связанные категории', body: 'Для {topic} оцените цель, ожидаемый формат, чувствительность источника, обратимость и того, кто будет использовать результат.', detail: 'Проверьте результат в реальном контексте: черновик публикации, отчет, клиентский пакет, техническая заметка или финансовая оценка.', relatedParagraph: 'Следующий шаг зависит от выбранного инструмента. При необходимости откройте обе категории и проверьте небольшой пример.', conclusion: '{topic} лучше решать через понятный процесс сравнения: определить задачу, разделить роли инструментов, проверить результат и избегать лишних преобразований.' },
    zh: { category: '对比指南', cover: '对比流程', read: '10 分钟阅读', lede: '{topic} 指南会按任务、输入、输出和风险区分两个相似选项。', summaryText: '对于 {topic}：先写下目标，比较输入和输出，用示例检查，然后选择下一步。', openTool: '打开对比中的工具', viewTools: '查看相关类别', body: '处理 {topic} 时，检查目的、预期格式、来源敏感性、可回退性，以及谁会使用结果。', detail: '在真实使用场景中检查结果：发布草稿、报告、客户包、技术说明或财务估算。', relatedParagraph: '下一步取决于你选择的工具。必要时打开两个类别，并用小样例测试。', conclusion: '{topic} 最适合用清晰的对比流程处理：定义任务、区分工具角色、验证结果，并避免不必要的转换。' },
    ja: { category: '比較ガイド', cover: '比較ワークフロー', read: '10分で読めます', lede: '{topic}のガイドは、似た選択肢をタスク、入力、出力、リスクで分けて考えるためのものです。', summaryText: '{topic}では、目的を書き出し、入力と出力を比較し、例で確認して次の手順を1つ選びます。', openTool: '比較対象のツールを開く', viewTools: '関連カテゴリを見る', body: '{topic}では、目的、期待する形式、元データの機密性、戻せるかどうか、結果を使う人を確認します。', detail: '公開下書き、レポート、クライアント資料、技術メモ、財務見積もりなど実際の場面で結果を確認します。', relatedParagraph: '次の手順は選んだツールによって変わります。必要なら両方のカテゴリを開き、小さな例で試します。', conclusion: '{topic}は明確な比較ワークフローで扱うのが安全です。タスクを定義し、ツールの役割を分け、結果を検証し、不要な変換を避けます。' },
    ko: { category: '비교 가이드', cover: '비교 워크플로', read: '10분 읽기', lede: '{topic} 가이드는 비슷한 두 선택지를 작업, 입력, 출력, 위험 기준으로 나누어 봅니다.', summaryText: '{topic}에서는 목표를 적고, 입력과 출력을 비교하고, 예제로 확인한 뒤 다음 단계를 하나 선택하세요.', openTool: '비교한 도구 열기', viewTools: '관련 카테고리 보기', body: '{topic}에서는 목적, 예상 형식, 원본의 민감도, 되돌릴 수 있는지, 결과를 사용할 사람을 확인하세요.', detail: '게시 초안, 보고서, 고객 패키지, 기술 메모 또는 재무 추정처럼 실제 맥락에서 결과를 확인하세요.', relatedParagraph: '다음 단계는 선택한 도구에 따라 달라집니다. 필요하면 두 카테고리를 열고 작은 예제로 테스트하세요.', conclusion: '{topic}은 명확한 비교 워크플로에서 가장 잘 처리됩니다. 작업을 정의하고 도구 역할을 나누며 결과를 검증하고 불필요한 변환을 피하세요.' },
    ar: { category: 'أدلة المقارنة', cover: 'سير المقارنة', read: 'قراءة 10 دقائق', lede: 'يساعدك دليل {topic} على فصل خيارين متشابهين حسب المهمة والمدخلات والمخرجات والمخاطر.', summaryText: 'في {topic} اكتب الهدف، قارن المدخلات والمخرجات، اختبر بمثال، ثم اختر الخطوة التالية.', openTool: 'افتح الأداة المقارنة', viewTools: 'عرض الفئات المرتبطة', body: 'عند {topic} راجع الغرض والتنسيق المتوقع وحساسية المصدر وقابلية التراجع ومن سيستخدم النتيجة.', detail: 'تحقق من النتيجة في السياق الحقيقي: مسودة نشر أو تقرير أو حزمة عميل أو ملاحظة تقنية أو تقدير مالي.', relatedParagraph: 'تعتمد الخطوة التالية على الأداة التي اخترتها. افتح الفئتين عند الحاجة واختبر مثالًا صغيرًا.', conclusion: 'ينجح {topic} أكثر مع سير مقارنة واضح: عرّف المهمة، افصل أدوار الأدوات، تحقق من النتيجة وتجنب التحويلات غير الضرورية.' },
    hi: { category: 'Comparison guides', cover: 'Comparison workflow', read: '10 मिनट पढ़ें', lede: '{topic} guide दो मिलते-जुलते options को task, input, output और risk के आधार पर अलग करता है।', summaryText: '{topic} में goal लिखें, inputs और outputs compare करें, example से check करें और एक next step चुनें।', openTool: 'Compared tool खोलें', viewTools: 'Related categories देखें', body: '{topic} में purpose, expected format, source sensitivity, reversibility और result इस्तेमाल करने वाले व्यक्ति को देखें।', detail: 'Result को real context में check करें: publishing draft, report, client package, technical note या finance estimate.', relatedParagraph: 'अगला step चुने गए tool पर निर्भर करता है। ज़रूरत हो तो दोनों categories खोलें और छोटे example से test करें।', conclusion: '{topic} clear comparison workflow में सबसे अच्छा है: task define करें, tool roles अलग करें, result validate करें और unnecessary conversions से बचें।' },
    it: { category: 'Guide di confronto', cover: 'Workflow confronto', read: '10 min di lettura', lede: 'Questa guida su {topic} distingue due opzioni simili per attività, input, output e rischio.', summaryText: 'Per {topic}, scrivi l’obiettivo, confronta input e output, verifica con un esempio e scegli il passo successivo.', openTool: 'Apri strumento confrontato', viewTools: 'Vedi categorie correlate', body: 'In {topic}, valuta scopo, formato atteso, sensibilità della fonte, reversibilità e chi userà il risultato.', detail: 'Controlla il risultato nel contesto reale: bozza di pubblicazione, report, pacchetto cliente, nota tecnica o stima finanziaria.', relatedParagraph: 'Il passo successivo dipende dallo strumento scelto. Apri le categorie se serve e prova con un piccolo esempio.', conclusion: '{topic} funziona meglio con un workflow di confronto chiaro: definisci l’attività, separa i ruoli degli strumenti, valida il risultato ed evita conversioni inutili.' },
    pl: { category: 'Przewodniki porównawcze', cover: 'Proces porównania', read: '10 min czytania', lede: 'Ten poradnik o {topic} rozdziela dwie podobne opcje według zadania, wejścia, wyjścia i ryzyka.', summaryText: 'Dla {topic}: zapisz cel, porównaj wejścia i wyjścia, sprawdź na przykładzie i wybierz następny krok.', openTool: 'Otwórz porównywane narzędzie', viewTools: 'Zobacz powiązane kategorie', body: 'Przy {topic} sprawdź cel, oczekiwany format, wrażliwość źródła, odwracalność i osobę używającą wyniku.', detail: 'Sprawdź wynik w realnym kontekście: szkicu publikacji, raporcie, pakiecie klienta, notatce technicznej lub szacunku finansowym.', relatedParagraph: 'Następny krok zależy od wybranego narzędzia. W razie potrzeby otwórz obie kategorie i przetestuj mały przykład.', conclusion: '{topic} najlepiej działa z jasnym procesem porównania: określ zadanie, rozdziel role narzędzi, zweryfikuj wynik i unikaj zbędnych konwersji.' },
    nl: { category: 'Vergelijkingsgidsen', cover: 'Vergelijkingsworkflow', read: '10 min lezen', lede: 'Deze gids over {topic} scheidt twee vergelijkbare opties op taak, invoer, uitvoer en risico.', summaryText: 'Voor {topic}: noteer het doel, vergelijk invoer en uitvoer, test met een voorbeeld en kies de volgende stap.', openTool: 'Vergeleken tool openen', viewTools: 'Gerelateerde categorieën bekijken', body: 'Let bij {topic} op doel, verwacht formaat, gevoeligheid van de bron, omkeerbaarheid en wie het resultaat gebruikt.', detail: 'Controleer het resultaat in de echte context: publicatieconcept, rapport, klantpakket, technische notitie of financiële schatting.', relatedParagraph: 'De volgende stap hangt af van de gekozen tool. Open zo nodig beide categorieën en test met een klein voorbeeld.', conclusion: '{topic} werkt het best met een duidelijke vergelijkingsworkflow: definieer de taak, scheid toolrollen, valideer het resultaat en vermijd onnodige conversies.' }
  };

  var PHASE10_WORKFLOW_COPY = {
    tr: { category: 'İş akışı planlama', cover: 'Planlama iş akışı', read: '10 dk okuma', lede: '{topic} rehberi birden fazla aracı düzenli, kontrol edilebilir ve tekrarlanabilir bir çalışma sırasına koymanıza yardımcı olur.', summaryText: '{topic} için başlangıç dosyasını koruyun, adımları sıraya koyun, her çıktıyı kontrol edin ve paylaşmadan önce son bağlamı gözden geçirin.', openTool: 'İlgili aracı aç', viewTools: 'İş akışı kategorilerini görüntüle', body: '{topic} planlarken kaynak dosyayı, hedef kullanıcıyı, gereken araç sırasını, kontrol noktalarını ve dosya adlandırmayı netleştirin.', detail: 'Akışı gerçek teslim yerinde deneyin: ekip klasörü, müşteri e-postası, destek talebi, pano içe aktarımı veya aylık kayıt.', relatedParagraph: 'Sonraki adım iş akışındaki ilk eksik parçaya bağlıdır. Gerekirse kategori merkezini açın ve akışı küçük bir örnekle prova edin.', conclusion: '{topic} görünür bir planla daha güvenlidir: dosyaları koruyun, adımları ayırın, çıktıları doğrulayın ve son paylaşım bağlamını kontrol edin.' },
    de: { category: 'Workflow-Planung', cover: 'Planungsworkflow', read: '10 Min. Lesezeit', lede: 'Dieser Leitfaden zu {topic} ordnet mehrere Tools in eine klare, prüfbare und wiederholbare Arbeitsfolge.', summaryText: 'Für {topic}: Ausgangsdatei sichern, Schritte ordnen, jede Ausgabe prüfen und vor dem Teilen den Kontext kontrollieren.', openTool: 'Verwandtes Tool öffnen', viewTools: 'Workflow-Kategorien ansehen', body: 'Planen Sie bei {topic} Quelldatei, Zielnutzer, Tool-Reihenfolge, Prüfpunkte und Dateibenennung ausdrücklich.', detail: 'Testen Sie den Workflow am echten Übergabeort: Teamordner, Kunden-E-Mail, Support-Ticket, Dashboard-Import oder Monatsablage.', relatedParagraph: 'Der nächste Schritt hängt von der ersten fehlenden Workflow-Komponente ab. Öffnen Sie bei Bedarf die Kategorie und proben Sie mit einem kleinen Beispiel.', conclusion: '{topic} ist mit einem sichtbaren Plan sicherer: Dateien schützen, Schritte trennen, Ausgaben validieren und den finalen Teilen-Kontext prüfen.' },
    fr: { category: 'Planification de workflow', cover: 'Workflow de planification', read: '10 min de lecture', lede: 'Ce guide sur {topic} place plusieurs outils dans une séquence claire, contrôlable et répétable.', summaryText: 'Pour {topic}, gardez le fichier source, ordonnez les étapes, vérifiez chaque sortie et contrôlez le contexte final avant partage.', openTool: 'Ouvrir l’outil lié', viewTools: 'Voir les catégories de workflow', body: 'Pour {topic}, clarifiez fichier source, utilisateur cible, ordre des outils, points de contrôle et nommage des fichiers.', detail: 'Essayez le workflow au vrai point de livraison : dossier d’équipe, e-mail client, ticket support, import dashboard ou archive mensuelle.', relatedParagraph: 'L’étape suivante dépend de la première pièce manquante du workflow. Ouvrez la catégorie si nécessaire et répétez avec un petit exemple.', conclusion: '{topic} est plus sûr avec un plan visible : protéger les fichiers, séparer les étapes, valider les sorties et vérifier le contexte final de partage.' },
    es: { category: 'Planificación de flujos', cover: 'Flujo de planificación', read: '10 min de lectura', lede: 'Esta guía de {topic} coloca varias herramientas en una secuencia clara, revisable y repetible.', summaryText: 'Para {topic}, conserve el archivo inicial, ordene los pasos, revise cada salida y compruebe el contexto final antes de compartir.', openTool: 'Abrir herramienta relacionada', viewTools: 'Ver categorías de flujo', body: 'Al planificar {topic}, aclare archivo fuente, usuario objetivo, orden de herramientas, puntos de control y nombres de archivo.', detail: 'Pruebe el flujo en el lugar real de entrega: carpeta del equipo, correo del cliente, ticket de soporte, importación al panel o archivo mensual.', relatedParagraph: 'El siguiente paso depende de la primera pieza faltante del flujo. Abra la categoría si hace falta y ensaye con un ejemplo pequeño.', conclusion: '{topic} es más seguro con un plan visible: proteger archivos, separar pasos, validar salidas y revisar el contexto final de uso compartido.' },
    pt: { category: 'Planejamento de fluxo', cover: 'Fluxo de planejamento', read: '10 min de leitura', lede: 'Este guia sobre {topic} organiza várias ferramentas em uma sequência clara, verificável e repetível.', summaryText: 'Para {topic}, preserve o arquivo inicial, ordene as etapas, verifique cada saída e revise o contexto final antes de compartilhar.', openTool: 'Abrir ferramenta relacionada', viewTools: 'Ver categorias de fluxo', body: 'Ao planejar {topic}, esclareça arquivo de origem, usuário final, ordem das ferramentas, pontos de verificação e nomes de arquivo.', detail: 'Teste o fluxo no local real de entrega: pasta da equipe, e-mail do cliente, ticket de suporte, importação de dashboard ou arquivo mensal.', relatedParagraph: 'O próximo passo depende da primeira peça ausente do fluxo. Abra a categoria se necessário e ensaie com um exemplo pequeno.', conclusion: '{topic} fica mais seguro com um plano visível: proteja arquivos, separe etapas, valide saídas e revise o contexto final de compartilhamento.' },
    ru: { category: 'Планирование workflow', cover: 'Планировочный workflow', read: '10 мин чтения', lede: 'Руководство по {topic} выстраивает несколько инструментов в понятную, проверяемую и повторяемую последовательность.', summaryText: 'Для {topic}: сохраните исходный файл, упорядочьте шаги, проверяйте каждый результат и перед отправкой оцените финальный контекст.', openTool: 'Открыть связанный инструмент', viewTools: 'Смотреть категории workflow', body: 'Планируя {topic}, уточните исходный файл, целевого пользователя, порядок инструментов, контрольные точки и имена файлов.', detail: 'Проверьте workflow в реальном месте передачи: командная папка, письмо клиенту, тикет поддержки, импорт в дашборд или ежемесячный архив.', relatedParagraph: 'Следующий шаг зависит от первого недостающего элемента workflow. При необходимости откройте категорию и прогоните небольшой пример.', conclusion: '{topic} безопаснее с видимым планом: защищайте файлы, разделяйте шаги, проверяйте результаты и контролируйте финальный контекст обмена.' },
    zh: { category: '流程规划', cover: '规划流程', read: '10 分钟阅读', lede: '{topic} 指南会把多个工具放进清晰、可检查、可重复的工作顺序中。', summaryText: '对于 {topic}：保留初始文件，排列步骤，检查每个输出，并在共享前确认最终场景。', openTool: '打开相关工具', viewTools: '查看流程类别', body: '规划 {topic} 时，明确源文件、目标使用者、工具顺序、检查点和文件命名。', detail: '在真实交付位置试运行流程：团队文件夹、客户邮件、支持工单、仪表盘导入或每月归档。', relatedParagraph: '下一步取决于流程中第一个缺失环节。必要时打开类别，并用小样例演练。', conclusion: '{topic} 有可见计划会更安全：保护文件、拆分步骤、验证输出，并检查最终共享场景。' },
    ja: { category: 'ワークフロー計画', cover: '計画ワークフロー', read: '10分で読めます', lede: '{topic}のガイドは、複数のツールを明確で確認しやすく繰り返せる作業順に並べます。', summaryText: '{topic}では、元ファイルを残し、手順を並べ、各出力を確認し、共有前に最終文脈を見直します。', openTool: '関連ツールを開く', viewTools: 'ワークフローカテゴリを見る', body: '{topic}を計画するときは、元ファイル、対象ユーザー、ツール順、確認点、ファイル名を明確にします。', detail: 'チームフォルダー、顧客メール、サポートチケット、ダッシュボード取り込み、月次記録など実際の受け渡し場所で試します。', relatedParagraph: '次の手順はワークフローで最初に不足している部分によって変わります。必要ならカテゴリを開き、小さな例でリハーサルします。', conclusion: '{topic}は見える計画があるほど安全です。ファイルを守り、手順を分け、出力を検証し、最後の共有文脈を確認します。' },
    ko: { category: '워크플로 계획', cover: '계획 워크플로', read: '10분 읽기', lede: '{topic} 가이드는 여러 도구를 명확하고 확인 가능하며 반복 가능한 작업 순서로 정리합니다.', summaryText: '{topic}에서는 시작 파일을 보존하고, 단계를 순서대로 두고, 각 출력을 확인한 뒤 공유 전 최종 맥락을 검토하세요.', openTool: '관련 도구 열기', viewTools: '워크플로 카테고리 보기', body: '{topic}를 계획할 때 원본 파일, 대상 사용자, 필요한 도구 순서, 확인 지점, 파일 이름을 명확히 하세요.', detail: '팀 폴더, 고객 이메일, 지원 티켓, 대시보드 가져오기 또는 월간 기록처럼 실제 전달 위치에서 흐름을 시험하세요.', relatedParagraph: '다음 단계는 워크플로에서 처음 부족한 부분에 따라 달라집니다. 필요하면 카테고리를 열고 작은 예제로 리허설하세요.', conclusion: '{topic}은 보이는 계획이 있을 때 더 안전합니다. 파일을 보호하고, 단계를 분리하고, 출력을 검증하며 마지막 공유 맥락을 확인하세요.' },
    ar: { category: 'تخطيط سير العمل', cover: 'سير التخطيط', read: 'قراءة 10 دقائق', lede: 'يرتب دليل {topic} عدة أدوات في تسلسل واضح قابل للمراجعة والتكرار.', summaryText: 'في {topic} احتفظ بالملف الأصلي، رتّب الخطوات، راجع كل مخرج، وتحقق من سياق المشاركة النهائي.', openTool: 'افتح الأداة المرتبطة', viewTools: 'عرض فئات سير العمل', body: 'عند تخطيط {topic} وضّح ملف المصدر والمستخدم المستهدف وترتيب الأدوات ونقاط الفحص وتسمية الملفات.', detail: 'جرّب السير في مكان التسليم الحقيقي: مجلد الفريق أو بريد العميل أو تذكرة الدعم أو استيراد اللوحة أو السجل الشهري.', relatedParagraph: 'تعتمد الخطوة التالية على أول جزء ناقص في سير العمل. افتح الفئة عند الحاجة وجرّب مثالًا صغيرًا.', conclusion: 'يصبح {topic} أكثر أمانًا بخطة مرئية: احمِ الملفات، افصل الخطوات، تحقق من المخرجات وراجع سياق المشاركة النهائي.' },
    hi: { category: 'Workflow planning', cover: 'Planning workflow', read: '10 मिनट पढ़ें', lede: '{topic} guide कई tools को clear, checkable और repeatable work order में रखने में मदद करता है।', summaryText: '{topic} में starting file बचाएँ, steps को order में रखें, हर output check करें और share करने से पहले final context review करें।', openTool: 'Related tool खोलें', viewTools: 'Workflow categories देखें', body: '{topic} plan करते समय source file, target user, tool order, checkpoints और file naming स्पष्ट करें।', detail: 'Workflow को real delivery place में try करें: team folder, client email, support ticket, dashboard import या monthly record.', relatedParagraph: 'अगला step workflow के पहले missing part पर निर्भर करता है। ज़रूरत हो तो category खोलें और छोटे example से rehearsal करें।', conclusion: '{topic} visible plan के साथ ज़्यादा safe है: files protect करें, steps अलग रखें, outputs validate करें और final sharing context check करें।' },
    it: { category: 'Pianificazione workflow', cover: 'Workflow di pianificazione', read: '10 min di lettura', lede: 'Questa guida su {topic} mette più strumenti in una sequenza chiara, controllabile e ripetibile.', summaryText: 'Per {topic}, conserva il file iniziale, ordina i passaggi, controlla ogni output e rivedi il contesto finale prima di condividere.', openTool: 'Apri strumento correlato', viewTools: 'Vedi categorie workflow', body: 'Quando pianifichi {topic}, chiarisci file sorgente, utente finale, ordine degli strumenti, punti di controllo e nomi dei file.', detail: 'Prova il workflow nel vero punto di consegna: cartella team, e-mail cliente, ticket supporto, import dashboard o archivio mensile.', relatedParagraph: 'Il passo successivo dipende dal primo elemento mancante del workflow. Apri la categoria se serve e prova con un piccolo esempio.', conclusion: '{topic} è più sicuro con un piano visibile: proteggi i file, separa i passaggi, valida gli output e controlla il contesto finale di condivisione.' },
    pl: { category: 'Planowanie workflow', cover: 'Proces planowania', read: '10 min czytania', lede: 'Ten poradnik o {topic} układa wiele narzędzi w jasną, sprawdzalną i powtarzalną kolejność pracy.', summaryText: 'Dla {topic}: zachowaj plik startowy, uporządkuj kroki, sprawdzaj każdy wynik i przed udostępnieniem przejrzyj końcowy kontekst.', openTool: 'Otwórz powiązane narzędzie', viewTools: 'Zobacz kategorie workflow', body: 'Planując {topic}, doprecyzuj plik źródłowy, odbiorcę, kolejność narzędzi, punkty kontroli i nazwy plików.', detail: 'Przetestuj proces w realnym miejscu dostawy: folderze zespołu, e-mailu klienta, zgłoszeniu supportu, imporcie dashboardu lub miesięcznym archiwum.', relatedParagraph: 'Następny krok zależy od pierwszego brakującego elementu procesu. W razie potrzeby otwórz kategorię i przećwicz mały przykład.', conclusion: '{topic} jest bezpieczniejszy z widocznym planem: chroń pliki, rozdziel kroki, weryfikuj wyniki i sprawdzaj końcowy kontekst udostępniania.' },
    nl: { category: 'Workflowplanning', cover: 'Planningsworkflow', read: '10 min lezen', lede: 'Deze gids over {topic} zet meerdere tools in een duidelijke, controleerbare en herhaalbare werkvolgorde.', summaryText: 'Voor {topic}: bewaar het startbestand, orden de stappen, controleer elke uitvoer en bekijk de laatste deelcontext.', openTool: 'Gerelateerde tool openen', viewTools: 'Workflowcategorieën bekijken', body: 'Maak bij {topic} bronbestand, doelgebruiker, toolvolgorde, controlepunten en bestandsnamen expliciet.', detail: 'Test de workflow op de echte afleverplek: teammap, klantmail, supportticket, dashboardimport of maandarchief.', relatedParagraph: 'De volgende stap hangt af van het eerste ontbrekende onderdeel in de workflow. Open zo nodig de categorie en oefen met een klein voorbeeld.', conclusion: '{topic} is veiliger met een zichtbaar plan: bescherm bestanden, scheid stappen, valideer uitvoer en controleer de laatste deelcontext.' }
  };

  var PHASE1_GENERATED_BLOG_PHASES = [
    { slugs: PHASE1_BLOG_SLUGS, titles: PHASE1_TOPIC_TITLES },
    { slugs: PHASE2_BLOG_SLUGS, titles: PHASE2_TOPIC_TITLES, copy: PHASE2_IMAGE_COPY },
    { slugs: PHASE3_BLOG_SLUGS, titles: PHASE3_TOPIC_TITLES, copy: PHASE3_TEXT_COPY },
    { slugs: PHASE4_BLOG_SLUGS, titles: PHASE4_TOPIC_TITLES, copy: PHASE4_DEVELOPER_COPY },
    { slugs: PHASE5_BLOG_SLUGS, titles: PHASE5_TOPIC_TITLES, copy: PHASE5_CONVERTER_COPY },
    { slugs: PHASE6_BLOG_SLUGS, titles: PHASE6_TOPIC_TITLES, copy: PHASE6_FINANCE_COPY },
    { slugs: PHASE7_BLOG_SLUGS, titles: PHASE7_TOPIC_TITLES, copy: PHASE7_DATA_COPY },
    { slugs: PHASE8_BLOG_SLUGS, titles: PHASE8_TOPIC_TITLES, copy: PHASE8_PRIVACY_COPY },
    { slugs: PHASE9_BLOG_SLUGS, titles: PHASE9_TOPIC_TITLES, copy: PHASE9_COMPARISON_COPY },
    { slugs: PHASE10_BLOG_SLUGS, titles: PHASE10_TOPIC_TITLES, copy: PHASE10_WORKFLOW_COPY }
  ];

  function phase1FindGeneratedBlogPhase(slug) {
    for (var index = 0; index < PHASE1_GENERATED_BLOG_PHASES.length; index += 1) {
      var phase = PHASE1_GENERATED_BLOG_PHASES[index];
      if (Object.prototype.hasOwnProperty.call(phase.slugs, slug)) return phase;
    }
    return null;
  }
  ...
  function phase1LocalizeGeneratedBlogArticle() {
    ...
    if (!match) return;
    var phase = phase1FindGeneratedBlogPhase(match[1]);
    if (!phase) return;
    var topicKey = phase.slugs[match[1]];
    if (!topicKey) return;
    ...
    if (currentLanguage === 'en') {
      ...
      var englishTitles = phase.titles.en;
    ...
    var titlesByLanguage = phase.titles;
    var titles = titlesByLanguage[currentLanguage] || titlesByLanguage.en;
    if (!copy || !titles) return;
    if (phase.copy && phase.copy[currentLanguage]) {
      copy = Object.assign({}, copy, phase.copy[currentLanguage]);
    }
