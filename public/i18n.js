...
(function() {
  ...
  function phase1LocalizeGeneratedBlogArticle() {
    ...
    var topicKey = PHASE1_BLOG_SLUGS[match[1]] || PHASE2_BLOG_SLUGS[match[1]] || PHASE3_BLOG_SLUGS[match[1]] || PHASE4_BLOG_SLUGS[match[1]];
    if (!topicKey) return;
    ...
    if (currentLanguage === 'en') {
      ...
      var englishTitles = isPhase2Blog ? PHASE2_TOPIC_TITLES.en : (isPhase3Blog ? PHASE3_TOPIC_TITLES.en : (isPhase4Blog ? PHASE4_TOPIC_TITLES.en : PHASE1_TOPIC_TITLES.en));
    ...
    var titlesByLanguage = isPhase2Blog ? PHASE2_TOPIC_TITLES : (isPhase3Blog ? PHASE3_TOPIC_TITLES : (isPhase4Blog ? PHASE4_TOPIC_TITLES : PHASE1_TOPIC_TITLES));
