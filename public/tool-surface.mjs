const CATEGORY_CONFIG = {
  pdf: {
    label: 'PDF tools', route: '/categories/pdf-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  image: {
    label: 'Image tools', route: '/categories/image-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  finance: {
    label: 'Finance tools', route: '/categories/finance-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  dev: {
    label: 'Developer tools', route: '/categories/developer-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  text: {
    label: 'Text & writing tools', route: '/categories/text-writing.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  converters: {
    label: 'Converters', route: '/categories/converters.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  data: {
    label: 'Data tools', route: '/categories/data-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  design: {
    label: 'Design tools', route: '/categories/design-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  productivity: {
    label: 'Productivity tools', route: '/categories/productivity-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  security: {
    label: 'Security tools', route: '/categories/security-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
  ...
  social: {
    label: 'Social media tools', route: '/categories/social-media-tools.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
...
const DEFAULT_CONFIG = {
  label: 'Tool category', route: '/categories/index.html', guide: '/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html',
    ...
    <div class="nt-tool-helper__grid">
      ...
      <article>
        ...
        <div class="nt-tool-link-list">
          ...
          <a href="/blog/articles/browser-based-tools-vs-desktop-software-privacy-comparison.html">Browser-first tools<span>Guide</span></a>
        </div>
      </article>
      <article>
        <h3>FAQ</h3>
